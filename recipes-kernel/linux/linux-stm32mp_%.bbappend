...
KERNEL_CONFIG_FRAGMENTS:append:stm32mp25rt = " ${@bb.utils.contains('MACHINE_FEATURES', 'rt', '${S}/arch/arm64/configs/fragment-07-rt.config', '', d)}"
KERNEL_CONFIG_FRAGMENTS:append:stm32mp25rt = " ${@bb.utils.contains('MACHINE_FEATURES', 'rt', '${S}/arch/arm64/configs/fragment-07-rt-sysvinit.config', '', d)}"
